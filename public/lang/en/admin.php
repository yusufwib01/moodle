...
$string['configforcelogin'] = 'Normally, the site home and the course listings (but not courses) can be read by people without logging in to the site. If you want to force people to log in before they do ANYTHING on the site, then you should enable this setting. Note: This setting is locked when the Home page is disabled (see Navigation settings), as non-logged-in users are always redirected to the login page in that case.';
...
$string['enablemyhome_forcelogin_required'] = 'Home cannot be disabled while \'Force login\' is off, as non-logged-in users would have no accessible page.';
...
$string['forcelogin_enablemyhome_required'] = '\'Force login\' cannot be disabled while the Home page is disabled, as non-logged-in users would have no accessible page.';
